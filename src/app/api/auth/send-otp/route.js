...
const resend = new Resend((process.env.RESEND_API_KEY || 're_placeholderKey_123').trim());
...
export async function POST(request) {
  try {
    ...
    const rawFromEmail = process.env.RESEND_FROM_EMAIL || 'Soporte IT <no-reply@mankerz.xyz>';
